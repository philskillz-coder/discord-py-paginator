...
|                                     |                 |                     |                                                                             |                                                      |
| ``quick_navigation_button_hidden``  | ``bool``        | ``True``, ``False`` | _Is the quick navigation button hidden_                                     |                                                      |
...
|                                     |                 |                     |                                                                             |                                                      |
| ``page_number_button_hidden``       | ``bool``        | ``True``, ``False`` | _If the page number button hidden or not_                                   |                                                      |
...
|                                     |                 |                     |                                                                             |                                                      |
| ``search_button_button_hidden``     | ``bool``        | ``True``, ``False`` | _Is the search button hidden_                                               | Default: ``True``                                    |
...
|                                     |                 |                     |                                                                             |                                                      |
| ``first_element_button_hidden``     | ``bool``        | ``True``, ``False`` | _Is the first element button hidden_                                        |                                                      |
| ``first_element_button_enabled``    | ``bool``        | ``True``, ``False`` | _Whether the button to go to the first element should be enabled or not_    |                                                      |
...
|                                     |                 |                     |                                                                             |                                                      |
| ``prev_element_button_hidden``      | ``bool``        | ``True``, ``False`` | _Is the previous element button hidden_                                     |                                                      |
| ``prev_element_button_enabled``     | ``bool``        | ``True``, ``False`` | _Whether the button to go to the previous element should be enabled or not_ |                                                      |
...
|                                     |                 |                     |                                                                             |                                                      |
| ``next_element_button_hidden``      | ``bool``        | ``True``, ``False`` | _Is the next element button hidden_                                         |                                                      |
| ``next_element_button_enabled``     | ``bool``        | ``True``, ``False`` | _Whether the button to go to the next element should be enabled or not_     |                                                      |
...
|                                     |                 |                     |                                                                             |                                                      |
| ``last_element_button_hidden``      | ``bool``        | ``True``, ``False`` | _Is the last element button hidden_                                         |                                                      |
| ``last_element_button_enabled``     | ``bool``        | ``True``, ``False`` | _Whether the button to go to the last element should be enabled or not_     |                                                      |
...
|                                     |                 |                     |                                                                             |                                                      |
| ``placeholder_button_hidden``       | ``bool``        | ``True``, ``False`` | _If placeholder buttons are hidden or not_                                  |                                                      |
